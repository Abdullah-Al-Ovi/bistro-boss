                ...
                <div className="mt-8">
                    <form action="#" onSubmit={handleSignIn} autoComplete="off">
                        ...
                        <div>
                            ...
                            <div>
                                <input onChange={handleValidateCaptcha} type="text" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"name="captcha" placeholder='Type the above captcha' />
                            </div>
                        </div>
